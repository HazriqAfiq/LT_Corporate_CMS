...
export default function Edit({ member }) {
    ...
    const [imagePreview, setImagePreview] = useState(getImageUrl(member.image_path));
    const [imageSize, setImageSize] = useState(null);

    const handleImageDrop = (file) => {
        if (!file) {
            setData('image', null);
            setImagePreview(getImageUrl(member.image_path));
            setImageSize(null);
            return;
        }
        setData('image', file);
    ...
    const submit = (e) => {
        ...
        // Since we are uploading an optional file, we MUST use a POST request with _method: 'PUT'
    ...
    return (
        <AdminLayout header="Kemaskini Ahli Pasukan">
            <Head title="Kemaskini Ahli Pasukan | Admin" />
