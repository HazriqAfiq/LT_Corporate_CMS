...
export default function Create() {
    ...
    const { data, setData, processing, errors, isDirty, setError, clearErrors } = useForm({
        name: '',
        name_en: '',
        description: '',
        description_en: '',
    ...
    const submit = (e) => {
        ...
        window.axios.post(route('admin.services.store'), data)
            .then(() => {
                setShowTick(true);
                setTimeout(() => {
                    setShowTick(false);
    ...
    return (
        <AdminLayout header={t('add_service')}>
            <Head title={`${t('add_service')} | Admin`} />
                        ...
                        <div className="bg-[#0c0c0e] rounded-2xl border border-white/5 overflow-hidden">
                            ...
                            <div className="p-6 space-y-6">
                                ...
                                <div className="pt-6 border-t border-white/5">
                                    <label className="block text-sm font-semibold text-white mb-2">{t('service_features')}</label>
                                    <p className="text-xs text-zinc-500 mb-4">{t('service_features_desc')}</p>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
