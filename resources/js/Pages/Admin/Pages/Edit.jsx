...
export default function Edit({ page }) {
    ...
    return (
        <AdminLayout header="Edit Halaman">
            <Head title={`Edit ${page.title} | Admin`} />

            <div className="max-w-5xl mx-auto">
                <div className="mb-6 flex justify-between items-center">
                    <Link href={route('admin.pages.index')} className="text-zinc-500 hover:text-[var(--gold)] flex items-center transition-colors">
                        <ArrowLeft className="w-4 h-4 mr-1" />
                        Kembali ke Senarai Halaman
                    </Link>
                    <div className="flex gap-2">
                        {page.is_published && (
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="inline-flex items-center px-4 py-2 border border-white/10 rounded-lg text-sm font-medium text-zinc-200 bg-white dark:bg-gray-800 hover:bg-[#080808] dark:hover:bg-white/5 transition-colors"
                            >
                    ...
                    <div className="flex-1 space-y-6">
                        ...
                        <div className="bg-[#0c0c0e] rounded-2xl border border-white/5 overflow-hidden">
                            <div className="p-6 border-b border-white/5">
                                <h2 className="text-base font-bold text-white">Kandungan Halaman</h2>
                            </div>
                            <div className="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <RichTextEditor value={data.content} onChange={c => setData('content', c)} />
                                </div>

                                <div className="pt-6 border-t border-white/5">
                                    <label className="block text-sm font-medium text-zinc-300 mb-2">Kandungan (EN)</label>
                                    <RichTextEditor value={data.content_en} onChange={c => setData('content_en', c)} />
                                </div>
                        ...
                        <div className="bg-[#0c0c0e] rounded-2xl border border-white/5 overflow-hidden">
                            ...
                            <div className="p-6 space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label className="block text-sm font-medium text-zinc-300 mb-1">Meta Title (BM)</label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-zinc-300 mb-1">Meta Title (EN)</label>
                                        <input
                                            type="text"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label className="block text-sm font-medium text-zinc-300 mb-1">Meta Description (BM)</label>
                                        <textarea
                                            rows="3"
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-zinc-300 mb-1">Meta Description (EN)</label>
                                        <textarea
                                            rows="3"
                    ...
                    <div className="w-full lg:w-80 space-y-6 flex-shrink-0">
                        ...
                        <div className="bg-[#0c0c0e] rounded-2xl border border-white/5 overflow-hidden">
                            <div className="p-4 border-b border-white/5">
                                <h2 className="text-sm font-semibold text-white uppercase tracking-wide">Tetapan Halaman</h2>
                            </div>
                            <div className="p-4 space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex bg-[#080808] rounded-md border border-white/10 px-3 py-2">
                                        <span className="text-zinc-500 text-sm truncate">/{page.slug}</span>
                                    </div>
                                    <p className="mt-1 text-xs text-gray-500">Slug dijana secara automatik daripada tajuk.</p>
                                </div>
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-zinc-300 mb-1">Tarikh Terbit</label>
                                    <input
                                        type="datetime-local"
                        ...
                        <div className="bg-[#0c0c0e] rounded-2xl border border-white/5 overflow-hidden">
                            <div className="p-4">
                                <ImageUploadZone
                                    ...
                                    value={data.featured_image || (page.featured_image ? `/storage/${page.featured_image}` : null)}
