...
import { ArrowLeft, Save, UploadCloud, X, Info } from 'lucide-react';
...
export default function Create() {
    ...
    const handleImageDrop = (file) => {
        if (!file) { setData('image', null); setImagePreview(null); setImageSize(null); return; }
        setData('image', file);
    ...
    return (
        <AdminLayout header="Tambah Slider">
            <Head title="Tambah Slider | Admin" />
            ...
            <div className="max-w-5xl mx-auto">
                        ...
                        <div className="bg-[#0c0c0e] rounded-2xl border border-white/5 overflow-hidden">
                            ...
                            <div className="p-4">
                                        ...
                                        {imagePreview ? (
                                            <div className="relative w-full h-full group">
                                                ...
                                                <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                                                    ...
                                                    <button type="button" onClick={() => handleImageDrop(null)} className="px-4 py-2 bg-red-600 text-white text-xs font-bold rounded-lg">
                                                        Buang
                                                    </button>
                                                </div>
                                            </div>
                                ...
                                <div className="mt-3 flex items-start gap-2 text-[11px] text-zinc-600">
                                    ...
                                    <span>Gunakan imej 1920×1080 px untuk kualiti terbaik. Imej akan dipaparkan penuh-skrin di halaman utama.</span>
                                </div>
                            </div>
                        </div>
                ...
                <div className="fixed bottom-0 left-0 lg:left-64 right-0 bg-[#080808] border-t border-white/5 p-4 px-6 flex justify-end gap-3 z-30 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                    ...
                    >
                        ...
                        {processing ? 'Menyimpan...' : 'Simpan Slider'}
                    </button>
                </div>
