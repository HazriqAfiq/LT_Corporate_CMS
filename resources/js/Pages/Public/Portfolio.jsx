            ...
            <section className="relative pt-40 pb-24 overflow-hidden bg-[#080808] border-b border-white/5 z-10">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                        Projek <span className="text-[var(--gold)]">Kami</span>
                    </h1>
                    <p className="text-gray-300 max-w-2xl mx-auto text-lg leading-relaxed">
                        Projek yang telah kami siapkan untuk klien di pelbagai industri.
                    </p>
                </div>
            </section>

            {/* Portfolio Grid (Charcoal section with centered glow & gold divider lines) */}
                        ...
                        {projects.map(project => (
                            <Link key={project.id} href={`/portfolio/${project.slug}`} className="card group">
                                ...
                                <div className="p-6">
                                    ...
                                    <h3 className="text-lg font-bold text-white mb-2 group-hover:text-[var(--gold)] transition-colors">{project.title}</h3>
