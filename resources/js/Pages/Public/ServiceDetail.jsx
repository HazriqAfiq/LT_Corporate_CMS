            ...
            <section className="relative pt-40 pb-24 overflow-hidden bg-[#080808] border-b border-white/5 z-10" style={{ clipPath: 'inset(0)' }}>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" data-reveal="fade-up">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        <div className="w-10 h-10 flex items-center justify-center text-[var(--gold)]">
                    ...
                    {features.length > 0 && (
                        <div className="flex flex-wrap gap-3 mt-6">
                            {features.map((f, i) => (
                                <span key={i} className="text-xs bg-white/5 text-gray-300 px-3 py-1 rounded-md border border-white/10 backdrop-blur-sm">{f}</span>
                            ))}
                        </div>
                    )}
                </div>
