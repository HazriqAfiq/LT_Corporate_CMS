...
const NAV_GROUPS = [
    ...
    },
    {
        ...
        items: [
            { name: 'Halaman',  href: '/admin/pages',    icon: Layers },
            { name: 'Artikel',  href: '/admin/articles', icon: FileText },
            { name: 'Slider Utama',       href: '/admin/sliders',  icon: SlidersHorizontal },
            { name: 'Pasukan Kami',       href: '/admin/team-members', icon: Users },
            { name: 'Perpustakaan Media', href: '/admin/media',    icon: FolderOpen },
        ],
    },
    {
        label: 'Produk & Portfolio',
        items: [
            { name: 'Produk Digital',   href: '/admin/products', icon: Package },
            { name: 'Portfolio Projek', href: '/admin/projects', icon: Briefcase },
        ],
    },
    {
        label: 'Komunikasi',
        items: [
            { name: 'Inquiry',    href: '/admin/inquiries',  icon: MessageSquare },
    ...
    },
    {
        label: 'SEO & Analytics',
        items: [
            { name: 'SEO',       href: '/admin/seo-settings', icon: Globe },
    ...
    },
    {
        label: 'Sistem',
        items: [
            { name: 'Log Aktiviti',    href: '/admin/activity-logs', icon: Activity },
            { name: 'Backup',          href: '/admin/backup',        icon: Database },
            { name: 'Maklumat Sistem', href: '/admin/system-info',   icon: Server },
        ],
    },
    {
        label: 'Tetapan',
        items: [
            { name: 'Tetapan Website', href: '/admin/settings', icon: Settings },
        ],
    },
];
            ...
            <div className="lg:pl-64 flex flex-col min-h-screen relative z-10">
                    ...
                    <div className="flex items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="relative pl-3 border-l border-white/10">
                                ...
                                >
                                    <div className="w-7 h-7 rounded-full bg-[var(--gold)]/20 border border-[var(--gold)]/30 flex items-center justify-center shrink-0">
                                    ...
                                    <>
                                        ...
                                        <div className="absolute right-0 mt-2 w-56 rounded-2xl bg-[#0c0c0e] border border-white/5 shadow-2xl z-50 py-2 overflow-hidden origin-top-right animate-in fade-in slide-in-from-top-1 duration-150">
                                            <div className="px-4 py-2.5 border-b border-white/5">
                                                <p className="text-xs text-zinc-500 uppercase tracking-widest font-bold font-mono mb-1">Pengguna</p>
                ...
                <footer className="px-8 py-4 border-t border-white/5 text-center">
                    <p className="text-zinc-600 text-xs font-mono">
                        © {new Date().getFullYear()} Laman Teknologi · Admin Panel
                    </p>
                </footer>
            </div>
        </div>
