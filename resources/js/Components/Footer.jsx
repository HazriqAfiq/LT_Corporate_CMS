...
export default function Footer() {
    ...
    const activeSocials = ['facebook', 'instagram', 'linkedin', 'twitter', 'tiktok'].filter(social => {
        const url = settings[`social_${social}`];
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
                    ...
                    <div className="lg:col-span-2" data-reveal="fade-left">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed mb-4 max-w-sm font-sans">
                            {lang === 'en' 
                                ? (settings.company_about_en || 'The leading technology solutions provider for organizations. We help businesses grow through digital innovation.')
            ...
            <div className="border-t border-zinc-800/50" data-reveal="fade-in" data-reveal-delay="150">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
                        <p>
                            {lang === 'en'
                                ? (settings.footer_text_en || '© 2026 Laman Teknologi Sdn. Bhd. All Rights Reserved.')
