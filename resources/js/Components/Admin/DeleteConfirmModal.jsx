...
export default function DeleteConfirmModal({
    ...
    onConfirm = () => {},
    title = 'Sahkan Padam?',
    message = 'Anda pasti ingin memadam rekod ini? Tindakan ini tidak boleh dibatalkan.',
    processing = false,
}) {
    // Escape key listener
    useEffect(() => {
            ...
            >
                ...
                >
                    <DialogPanel className="relative w-full max-w-md bg-[#0c0c0e] border border-white/5 rounded-3xl p-6 shadow-2xl z-10 overflow-hidden transform transition-all group">
                        ...
                        <div className="absolute top-[-20%] left-[-20%] w-[200px] h-[200px] rounded-full bg-red-500/10 blur-[80px] pointer-events-none z-0" />
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center">
                            ...
                            <div className="relative mb-5 mt-2">
                                <div className="absolute -inset-2 bg-red-500/20 rounded-full blur-md opacity-75 group-hover:opacity-100 transition-opacity duration-300 animate-pulse" />
                                <div className="relative w-14 h-14 rounded-full bg-[#141416] border border-red-500/20 flex items-center justify-center">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 w-full mt-2">
                                ...
                                <button
                                    ...
                                    onClick={onConfirm}
                                    disabled={processing}
                                    className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-3 border border-transparent rounded-xl text-sm font-bold bg-red-600 hover:bg-red-500 text-white transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-red-600/10"
                                >
                                    {processing ? (
                                        <>
